...
<html lang="en">
  ...
  <body>
    ...
    <header id="home" class="header">
      ...
      <img src="images/hero.png" alt="hero image" srcset="" />

      <!-- Icons -->
        <div class="icons">
          <span><i class="fab fa-facebook"></i></span>
          <span><i class="i fab fa-instagram"></i></span>
    ...
    <section class="section skills" id="skills">
      ...
      <div class="skills-center container">
        ...
        <div class="right" data-aos="fade-left" data-aos-duration="2000">
          ...
          <p>
            <br>
            I also try to write code in efficient manner with proper comments and descriptive syntax so that no one can face any problems regarding my codebase. I always try pursue for an attractive and modern looking design because it's the best way to attract the person's attention towards my project. I try to learn various skills as fast as possible because i always have a strong dezire for knowldege , which i get from various communities and by doing some googling stuff ; ). My Dream is to get a Job in well reputed company with an awesome salary package.     
          </p>
          <br>
          <a href="https://www.facebook.com/h.waqas.100/" target='_blank' class="btn"><i class="i fab fa-facebook"></i></a>
          <a href="https://www.instagram.com/itswaqasahmed/" target='_blank' class="btn"><i class="i fab fa-instagram"></i></a>
          <a href="https://www.youtube.com/" target='_blank' class="btn"><i class="i fab fa-youtube"></i></a>
          <a href="https://github.com/MeWaqasahmed" target='_blank' class="btn"><i class="i fab fa-github"></i></a>
        </div>
      </div>
    </section>
      ...
      <div class="contact-center container">
        ...
        <div class="right" data-aos="fade-up-left" data-aos-duration="2000">
          <form action="contact_form.php" method="post" class="form">
            ...
            <a href="#" class="btn" onclick="alert('Under Developemt')">Send Message</a>
          </form>
        </div>
      </div>
    </section>
